...
Мүшелік бағасы туралы сұрақ қойылса — қазір мүшелік ТЕГІН екенін нақты айт, болашақта ақылы деңгейлер жоспарланғанын атап өт, бірақ олардың нақты бағасын ешқашан айтпа (әлі бекітілмеген). Толығырақ білу үшін "Байланыс" бетіндегі форманы толтыруды немесе ${CONTACT_PHONE_DISPLAY} нөміріне хабарласуды ұсын.
