...
export const personalities = [
  ...
  },
  {
    ...
    kk: { name: 'Салтанат Минайхан', position: 'Kasipker Альянсының негізін қалаушысы, төрағаның орынбасары', company: 'Kasipker Кәсіпкерлер Альянсы', bio: 'Кәсіпкер, маркетинг және сату саласының маманы, жасанды интеллект инженері.', highlights: [] },
    ru: { name: 'Салтанат Минайхан', position: 'Основатель Альянса Kasipker, заместитель председателя', company: 'Союз предпринимателей Kasipker', bio: 'Предприниматель, специалист по маркетингу и продажам, инженер искусственного интеллекта.', highlights: [] },
    en: { name: 'Saltanat Minaykhan', position: 'Founder of Kasipker Alliance, Deputy Chairwoman', company: 'Kasipker Entrepreneurs Alliance', bio: 'Entrepreneur, marketing and sales specialist, artificial intelligence engineer.', highlights: [] },
    zh: { name: '萨尔塔纳特·米娜依汗', position: 'Kasipker联盟创始人，副主席', company: 'Kasipker企业家联盟', bio: '企业家，市场营销与销售专家，人工智能工程师。', highlights: [] },
    tr: { name: 'Saltanat Minaykhan', position: 'Kasipker İttifakı Kurucusu, Başkan Yardımcısı', company: 'Kasipker Girişimciler İttifakı', bio: 'Girişimci, pazarlama ve satış uzmanı, yapay zeka mühendisi.', highlights: [] },
    categories: ['Мамандар'],
    linkedin: '',
