...
export const personalities = [
  ...
  },
  {
    ...
    kk: {
      ...
      highlights: ['Қытайдағы зауыт іздеу', 'OEM/СТМ өндіріс', 'Жеткізушілермен келіссөз', 'Халықаралық логистика', 'Кеден және сертификаттау', 'Толық сүйемелдеу'],
    },
    ru: {
      ...
      highlights: ['Поиск заводов в Китае', 'OEM/СТМ производство', 'Переговоры с поставщиками', 'Международная логистика', 'Таможня и сертификация', 'Полное сопровождение'],
    },
    en: {
      ...
      highlights: ['Sourcing Factories in China', 'OEM/Private Label Production', 'Supplier Negotiations', 'International Logistics', 'Customs & Certification', 'Full Support'],
    },
    zh: {
      name: '考萨尔·穆哈梅德克孜',
      position: '哈中物流部门总监',
      ...
      highlights: ['中国工厂寻源', 'OEM/自有品牌生产', '供应商谈判', '国际物流', '海关与认证', '全程支持'],
    },
    tr: {
      name: 'Kausar Mukhamedkyzy',
      ...
      highlights: ['Çin\'de Fabrika Bulma', 'OEM/Özel Marka Üretimi', 'Tedarikçi Müzakereleri', 'Uluslararası Lojistik', 'Gümrük ve Sertifikasyon', 'Tam Destek'],
    },
    categories: ['Мамандар'],
    linkedin: '',
    instagram: '',
